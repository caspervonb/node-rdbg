...
Console.prototype.enable = function(callback) {
  this.client.request('Console.enable', callback);
};
...
Debugger.prototype.getScriptSource = function(scriptId, callback) {
...
Debugger.prototype.setScriptSource = function(scriptId, source, callback) {
